...
public class TypeProcessor {
    ...
    public SeedConfig getSeedConfig() { return this.seedConfig; }

    public Class<?> getConfigType() { return this.seedConfig.getClass(); }

    public Set<UseFor> getDefaultIgnoreAct() { return defaultIgnoreAct; }
